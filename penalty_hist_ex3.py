...
ii = 3   #this indicates the level of final state, ex. 0 for ground state
#ma = nk.models.RBM(alpha=1, dtype=complex,use_visible_bias=True, use_hidden_bias=True)
#sampler = nk.sampler.MetropolisLocal(hilbert=hi)
...
fileName1 = "2021_summer_data/2022_winter_data/post_selection_data/parameter_N6i0j38_best.json"
file1 = open(fileName1,'rb')
a1 = pickle.load(file1)

fileName2 = "2021_summer_data/2022_winter_data/post_selection_data/parameter_N6i1j41_best.json"
file2 = open(fileName2,'rb')
a2 = pickle.load(file2)

fileName3 = "2021_summer_data/2022_winter_data/post_selection_data/parameter_N6i2j22_best.json"
file3 = open(fileName3,'rb')
a3 = pickle.load(file3)

para_list = [a1,a2,a3]
shift_list = [0.3,0.3,0.3]
...
ncpus = int(os.environ.get('SLURM_CPUS_PER_TASK',default=17))
