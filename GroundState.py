...
def runDescentCS(N,B,Ak,alpha,j):
    ...
    # Run RBM
    eng, state, runTime = rbm("2021_summer_data/test_data_shift_0.001/con_Logs"+str(N)+str(j)) #where _call_ will be invoked
...
for i in range(11):  #here put N-1 (maximum)
    ...
    fileName = "2021_summer_data/error_test_shift_0.001/para_con_N"+str(N)+"M" + str(M)+".json"
